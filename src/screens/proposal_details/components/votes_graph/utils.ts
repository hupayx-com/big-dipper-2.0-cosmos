  ...
  return ([
    {
      name: 'yes',
      value: data.yes,
      display: ""+formatDenom(data.yes, "ahpx").value,
    ...
    },
    {
      name: 'no',
      value: data.no,
      display: ""+formatDenom(data.no, "ahpx").value,
    ...
    },
    {
      name: 'veto',
      value: data.veto,
      display: ""+formatDenom(data.veto, "ahpx").value,
    ...
    },
    {
      name: 'abstain',
      value: data.abstain,
      display: ""+formatDenom(data.abstain, "ahpx").value,
