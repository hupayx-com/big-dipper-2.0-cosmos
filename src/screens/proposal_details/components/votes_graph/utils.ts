  ...
  return ([
    {
      name: 'yes',
      value: data.yes,
      display: ""+formatDenom(data.yes, "asfl").value,
    ...
    },
    {
      name: 'no',
      value: data.no,
      display: ""+formatDenom(data.no, "asfl").value,
    ...
    },
    {
      name: 'veto',
      value: data.veto,
      display: ""+formatDenom(data.veto, "asfl").value,
    ...
    },
    {
      name: 'abstain',
      value: data.abstain,
      display: ""+formatDenom(data.abstain, "asfl").value,
